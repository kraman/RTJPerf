// ************************************************************************
//    $Id: ScopedMemoryTimingTest.java,v 1.4 2002/12/05 04:07:21 corsaro Exp $
// ************************************************************************
//
//                               RTJPerf
//
...
public class ScopedMemoryTimingTest {
  ...
  static class TestLogic implements Runnable {
    ...
    public void run() {
      ...
      final AllocatorLogic allocatorLogic = new AllocatorLogic(timerEnter, timerExit, timerExec);
      ...
      final CTMemory bootstrapMA = new CTMemory(1024 * 1024);
